...
df = pd.DataFrame(pd.read_csv('../data/dev_en.tsv', sep='\t'), columns=['text'])
...
print(optimal_model[bow])
print(optimal_model.top_topics(corpus, topn=5))


def extract_topics_features(text):
    '''
    extract top 5(?) topics and use probability to text
     for feature
    '''
    pass
